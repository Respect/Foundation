...
default: .title
	...
	@echo "                   ====================================================================="
	@echo "            menu1: Project Scripts Menu"
	@echo "            menu2: Show Packaging Toolbox Menu"
	@echo "            menu3: Show Dev Toolbox Menu"
	@echo "            menu4: Show Deploy & Release"
	@echo ""
...
menu1: .title
	...
	@echo "    bootstrap-php: Create bootstrap.php for phpunit in test folder"
...
menu3: .title
	...
	@echo "install-uri-     : uri_template is a php extension written in c and will more than likely"
	@echo "         template: require sudo to gain write access to your extensions folder."
	@echo ""
